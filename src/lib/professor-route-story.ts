      ...
      scenes: [
        {
          ...
          type: "linear",
          stage_direction: [
            "화면 양옆이 어둡게 비네팅 처리되며 좁은 변기 칸의 느낌을 준다.",
            "어딘가에서 물방울이 '똑... 똑...' 떨어지는 소리가 들리고, 나의 손에는 비닐봉지가 반쯤 벗겨진 참치마요 김밥이 들려 있다.",
          ],
          lines: [
            { role: "narration", text: "고학번의 삶이란 철저한 고독과의 싸움이다. 동기들은 군대에 가거나 휴학했고, 후배들의 빛나는 무리에 끼기엔 내 학번이 너무 무겁다. 결국 시간표마저 꼬여 버린 오늘, 나는 학교 괴담으로만 듣던 '변기 칸 혼밥'의 주인공이 되고 말았다." },
        ...
        },
        {
          ...
          type: "linear",
          stage_direction: ["화면 전환. 화장실 세면대 앞.", "교수님이 손을 씻고 수건으로 닦으며, 방금 칸에서 기어 나온 나를 애잔하고 처연한 눈빛으로 바라본다."],
          lines: [
            ...
            { role: "professor", text: "당장 그 차갑고 눅눅한 김밥은 쓰레기통에 버리게. 따라와. 정문 앞 'Delicious Lion Steak House'로 가지. 내 제자가 변기 옆에서 참치마요를 씹고 있는 걸 본 이상, 그냥 지나치는 건 교육자의 도리가 아니야." },
          ],
        ...
        },
        {
          ...
          lines: [
            ...
            { role: "professor", text: "여기 포터하우스 그람 수 상관없이 한가득 주시죠, 이 친구가 아주 며칠 굶은 것처럼 휭하니까 많이 부탁드립니다!" },
          ],
          next_scene: "ep03b_scene09_outro",
        },
        {
      ...
      scenes: [
        {
          ...
          lines: [
            ...
            { role: "professor", text: "학생이군. 학식 줄이 길었나? 나도 오늘은 그쪽이 내키지 않아서.", action: "잠깐 멈칫하더니, 별일 아니라는 듯 자연스럽게 걸어오며" },
        ...
        },
        {
          ...
          lines: [
            ...
            { role: "professor", text: "여기 된장찌개가 무난하네. 나는 늘 그걸로 하는 편이야." },
            { role: "narration", text: "메뉴 추천인지 그냥 하는 말인지 모르겠는데, 나는 어느새 된장찌개 쪽으로 손가락이 향하고 있다." },
          ],
      ...
      scenes: [
        ...
        },
        {
          ...
          lines: [
            ...
            { role: "professor", text: "... 학생이군. 여기도 오나?", action: "서가에서 책을 훑어보다가, 인기척을 느끼고 고개를 돌리며" },
          ],
      ...
      scenes: [
        ...
        },
        {
          ...
          lines: [
            ...
            { role: "student", text: "오늘 정말 감사합니다, 교수님. 화장실에서 구해주신 것(?)부터, 한우에, 커피에... 그리고 시험에 대한 악랄한... 아니, 깊은 조언까지요." },
            ...
            { role: "professor", text: "내일 시험, 자네가 노력한 만큼의 결과가 나오길 바라네. 너무 긴장하지 말고. 자, 우산 받아 가게." },
            { role: "narration", text: "교수님이 건네준 고급 장우산을 받아 들고 연구실을 나섰다. 손잡이에 남은 그의 온기와 연구실의 향기가 가슴 속에 오래도록 맴돌았다." },
          ],
          next_scene: "ep06o_scene06_rolls_intro",
        },
        {
          id: "ep06o_scene06_rolls_intro",
          type: "linear",
          section_title: "클라이맥스: 롤스로이스와 백마 탄 기사",
          stage_direction: ["건물 밖 정문 앞. 비는 아까보다 더 세차게 쏟아지고 있다.", "천둥 번개가 번쩍이며 가로등 불빛에 비친 빗줄기가 날카롭게 핏발을 세운다.", "빗길을 가르며 다가오는 순백의 롤스로이스. 웅장한 프론트 그릴과 환희의 여신상이 빗속에서 번쩍인다.", "운전석 창문이 부드럽게 내려가고, 그 안에서 완벽한 수트 핏을 자랑하는 __ 교수님이 선글라스(이 밤에?)를 살짝 내리며 나를 바라본다."],
          lines: [
            { role: "narration", text: "연구실 로비에서 우산을 펴고 밖으로 나섰지만, 비는 예상보다 훨씬 거셌다. 우산을 써도 신발과 바지 끝단은 이미 젖어 들기 시작했다. 캄캄한 캠퍼스는 빗소리로 가득 찼고, 저 멀리 정문까지 걸어갈 엄두가 나지 않았다." },
            { role: "monologue", text: "와... 이 우산 없었으면 정말 큰일 날 뻔했다. 교수님... 츤데레 같지만 의외로 따뜻하신 분일지도." },
            { role: "narration", text: "한 걸음 한 걸음 힘겹게 빗속을 뚫고 지나가는데, 뒤쪽에서 묵직하고 부드러운 엔진 소리가 들려왔다. 가로등 불빛을 가르며 다가오는 것은... 어둠 속에서도 눈부시게 빛나는 순백의 롤스로이스 팬텀이었다." },
            { role: "monologue", text: "헉... 롤스로이스?! 우리 학교에 이런 차를 타는 사람이 있다고? 설마 이사장님인가?" },
            { role: "professor", text: "__ 학생. 거, 우산 받아 가라는 게, 나 차 타고 가니까 자네는 걸어가라는 뜻이었는데. 이 비를 뚫고 걸어갈 자신은 있나 보군?", action: "선글라스를 벗이며, 입가에 미세한 미소를 띠고" },
            { role: "student", text: "아... 교수님 차였어요?!" },
            { role: "professor", text: "이 우산 쓰고 정문까지 걸어가다간 시험 보기도 전에 감기 들겠어. 너만 괜찮다면, 이 '백마'에 타는 영광을 주지. 집까지 데려다주겠네." },
            { role: "narration", text: "교수님의 폭풍 같은 오지랖과 롤스로이스의 위압감에 정신을 차릴 수 없었다. 이 상황에서 나는 어떤 선택을 해야 할까?" },
          ],
          next_scene: "ep06o_choice02_rolls",
        },
        {
          id: "ep06o_choice02_rolls",
          type: "choice",
          prompt: "롤스로이스 앞 최종 선택",
          note: "중요: 엔딩 A/B/C 별도 표기 대신 선택지 1/2/3이 직접 엔딩 의미를 가짐.",
          choices: [
            { id: "ep06o_c02_opt01", label: "선택지 1", ending_meaning: "우산 사수", text: "마음만 감사히 받겠습니다, 교수님! 고급 차에 빗물 묻히고 싶지 않아요. 주신 우산 쓰고 천천히 가겠습니다!", next_scene: "ep06o_scene07_umbrella_keep" },
            { id: "ep06o_c02_opt02", label: "선택지 2", ending_meaning: "로망 실현", text: "그... 그럼 실례하겠습니다. 롤스로이스 승차감을 느껴보는 게 제 버킷리스트였거든요!", next_scene: "ep06o_scene08_romance_ride" },
            { id: "ep06o_c02_opt03", label: "선택지 3", ending_meaning: "거리 두기", text: "교수님, 이건 좀 아닌 것 같아요. 오늘 하루 너무 친해진 것 같아서 부담스럽습니다. 적당히 거리 좀 둬 주세요!", next_scene: "ep06o_scene09_distance" },
          ],
        },
        {
          id: "ep06o_scene07_umbrella_keep",
          type: "ending_branch",
          ending_name: "선택지 1 - 우산 사수",
          lines: [
            { role: "professor", text: "허! 자네, 의외로 고집이 있군. 좋아, 그 독립심은 높이 사지. 대신 감기 걸려서 내일 시험지에 콧물 흘리면 F니까 조심하게. 그럼, 내일 보세.", action: "조금 의외라는 듯 눈을 둥그렇게 떴다가, 이내 빙그레 웃으며" },
            { role: "narration", text: "나는 교수님이 주신 장우산에 의지해 세찬 빗속을 걸어 정문을 통과했다. 비록 바지는 다 젖었지만, 가슴 한구석은 이상하게 따뜻했다. 롤스로이스를 탄 교수님의 모습보다, 연구실에서 내 이름을 불러 주던 그의 목소리가 더 오래 기억에 남을 것 같은 밤이었다." },
          ],
          stage_direction: ["롤스로이스의 창문이 올라가고, 비를 뚫고 매끄럽게 사라진다.", "손에 쥔 교수님의 우산이 더욱 묵직하게 느껴진다."],
          next_scene: "ep06o_scene10_home_final",
        },
        {
          id: "ep06o_scene08_romance_ride",
          type: "ending_branch",
          ending_name: "선택지 2 - 로망 실현",
          lines: [
            { role: "professor", text: "하! 자네의 그 뻔뻔함과 솔직함은 정말 학계에서 연구 대상이야. 그래, 타게. 이 왕년의 '백마 탄 기사'가 자네의 버킷리스트를 하나 이뤄 주지.", action: "어이없다는 듯 헛웃음을 터뜨리며" },
            { role: "narration", text: "롤스로이스의 승차감은 상상 이상이었다. 밖에는 천둥 번개가 치고 있었지만, 차 안은 마치 다른 세상처럼 평온했다. 교수님은 운전하면서도 내일 시험의 핵심 포인트를 은밀하게(이번엔 진짜로!) 흘려 주셨고, 나는 꿈같은 시간을 보내며 집 앞에 도착했다." },
            { role: "professor", text: "자, 도착했네. 내일 시험, 이 롤스로이스의 기운을 받아서 꼭 좋은 결과 있길 바라네." },
            { role: "narration", text: "차에서 내리는 내 손에 교수님은 아까 그 우산을 꼭 쥐여 주셨다. 뜻밖의 횡재와 교수님의 따뜻한 배웅 덕분에, 내일 시험은 정말 잘 볼 수 있을 것 같은 근거 없는 자신감이 샘솟았다." },
          ],
          stage_direction: ["롤스로이스의 문이 열리고, 내가 조심스럽게 탑승한다.", "차 내부는 고급스러운 가죽 향기와 고요함으로 가득 차 있다.", "교수님이 부드럽게 차를 출발시킨다."],
          next_scene: "ep06o_scene10_home_final",
        },
        {
          id: "ep06o_scene09_distance",
          type: "ending_branch",
          ending_name: "선택지 3 - 거리 두기",
          lines: [
            { role: "professor", text: "허... 자네, 아주 칼 같군. 오해는 말게. 단지 제자가 이 비에 젖어 고생하는 게 안타까워 교육자로서 베푼 호의였네. 거리라... 그래, 그 선을 넘지 않는 것도 중요하지.", action: "잠시 당황한 듯 선글라스를 다시 고쳐 쓰더니, 이내 조금 씁쓸한 표정으로 웃으며" },
            { role: "narration", text: "순간, 아차 싶었다. 내 거절이 교수님께 상처가 된 건 아닐까? 하지만, 스승과 제자의 선은 분명해야 한다고 생각했다. 교수님이 사라진 캠퍼스는 아까보다 훨씬 더 차갑고 어둡게 느껴졌다. 손에 쥔 우산이 왠지 차갑게 식어 가는 것 같았다. 무거운 마음으로 빗속을 걸어 집으로 향했다." },
          ],
          stage_direction: ["교수님의 표정이 조금 딱딱해진다.", "차 문이 닫히고, 롤스로이스가 매정하게 비를 뚫고 사라진다."],
          next_scene: "ep06o_scene10_home_final",
        },
        {
          id: "ep06o_scene10_home_final",
          type: "linear",
          section_title: "진짜 최종: 집으로 돌아와서",
          stage_direction: ["나의 자취방 안. 창밖에는 아직도 빗소리가 아득하게 들려온다.", "나는 편안한 잠옷으로 갈아입고 침대에 누워 있다.", "스탠드 불빛만이 방안을 어렴풋이 비춘다.", "스탠드 불빛이 꺼지고, 화면이 점점 어두워진다.", "교수님의 우산이 방구석에 소중하게 놓여 있다."],
          lines: [
            { role: "narration", text: "파란만장했던 오늘 하루가 드디어 저물어 간다. 오늘 아침부터 시작해서 점심, 오후, 그리고 저녁, 마지막으로 연구실에서의 향기로운 커피와 이름 부름, 그리고 빗속에서의 롤스로이스까지... 정말 영화 같은 하루였다." },
            { role: "monologue", text: "교수님... 정말 알다가도 모를 분이야. 엄격한 줄만 알았는데, 의외로 장난기 많고 따뜻하고... 그리고 오늘 내 이름을 불러 줬을 때... (얼굴이 화끈거린다)" },
            { role: "narration", text: "머릿속에는 여전히 교수님의 목소리와 연구실의 향기가 감돌았다. 내일 시험에 대한 걱정보다, 오늘 교수님과 함께했던 시간들이 더 크게 자리 잡고 있었다. 교수님이 주신 우산 덕분에 감기는 안 걸리겠지." },
            { role: "monologue", text: "내일 시험... 꼭 잘 보자. 교수님이 실망하시지 않게. (이불을 머리까지 덮으며) 하아... 잠이 안 와... 그 롤스로이스는 정말 백마 같았어..." },
            { role: "narration", text: "나는 교수님의 우산을 바라보며, 설렘과 긴장감이 뒤섞인 묘한 기분으로 눈을 감았다. 내일은 또 어떤 일이 기다리고 있을까? 창밖의 빗소리가 자장가처럼 내 어깨를 토닥이는 밤이다." },
          ],
          terminal: true,
        },
      ],
    ...
    },
    {
      ...
      scenes: [
        ...
        },
        {
          ...
          lines: [
            { role: "professor", text: "학생.", action: "가방을 챙기며 문 쪽으로 걷다가, 문손잡이를 잡고 잠깐 멈추며" },
            { role: "student", text: "네." },
...
export const storyEndingCatalog: Record<StoryEndingRankKey, StoryEndingCatalogEntry> = {
    ...
    variants: [
      {
        ...
        lines: [
          {
            role: "professor",
            text: "__, 이번 시험 답안지 잘 봤네. 자네의 사고방식은... 딱 내 연구실에 필요한 수준이야. 졸업장? 그게 무슨 의미가 있나. 내 옆에서 나와 함께 인류의 지성을 한 단계 높여 보지 않겠나? 자네 자리는 이미 내 방 바로 옆에 마련해 두었네. 자, 도망갈 생각은 말고.",
          },
        ],
      },
      {
        ...
        lines: [
          {
            role: "professor",
            text: "A+? 아니, 자네에겐 그런 시시한 알파벳 따위 어울리지 않아. 자네에겐 '연구원'이라는 명칭이 훨씬 잘 어울리는군. 자네, 싹수가 아주 노란 게... 내 밑에서 제대로 한 번 굴러볼 생각 없나? 걱정 말게, 잠은 내가 재워 줄 테니까. 물론 연구실 소파에서 말이야.",
          },
        ],
      },
      {
        ...
        lines: [
          {
            role: "professor",
            text: "자네, 방금 제출한 답안지 말이야... 그 정도 수준이면 이제 학부 수업은 시간 낭비일 뿐이야. 내가 이미 자네 지도교수로 승인 신청 넣어 놨네. 내일부터는 강의실 말고 내 연구실로 출근하게. 아, 짐은 싸 올 필요 없어. 거기서 다 해결하게 해 줄 테니까. 자, __... 환영하네.",
          },
        ],
      },
      {
        ...
        lines: [
          {
            role: "professor",
            text: "시험이 끝나면 우리 인연이 끝날 줄 알았나? 천만에. 자네의 그 명석한 두뇌를 사회에 내보내는 건 국가적 손실이야. 아니, 내 개인적인 손실이지. __, 나랑 같이 연구해 보지 않겠나? 자네가 응답할 때까지 난 이 강의실 문을 잠그고 기다릴 생각이라네.",
          },
        ],
      },
    ],
    ...
    variants: [
      {
        id: "ending_b_01",
        subtype: "노예 계약형",
        title: "애매한 점수엔 애매한 형벌을",
        lines: [
          {
            role: "professor",
            text: "아주 잘 본 것도 아니고, 못 본 것도 아닌 참으로 애매한 점수군. 5점만 더 있었어도 A를 줬을 텐데 말이야. 아쉬운가? 그럼 그 부족한 점수는 내 밑에서 교양 과목 답안지 300장을 채점하며 채워 보지 않겠나? 빨간 펜은 내가 무상으로 지원하지.",
          },
        ],
      },
      {
        id: "ending_b_02",
        subtype: "안면 몰수형",
        title: "내 기억력은 학점에 비례한다네",
        lines: [
          {
            role: "professor",
            text: "아아... 자네가 그 평범하고 눈에 띄지 않는 B0 답안지의 주인공, __이었군. 미안하지만 내 두뇌 용량은 A학점 이상만 기억하게 세팅되어 있어서 말이야. 어제 있었던 일들은 다 끝났네. 그럼 이만 평범한 고학번의 삶으로 돌아가게.",
          },
        ],
      },
    ],
  ...
  c_plus_retake: {
    title: "C+ 재수강 — 방학이 끝나도 우린 끝이 아니야",
    variants: [
      {
        id: "ending_cplus_01",
        subtype: "불합격 통보형",
        title: "자네, 나랑 방학 보낼 준비 됐나?",
        lines: [
          {
            role: "professor",
            text: "학생, 이번 시험 답안지 잘 봤네. 잘 봤다는 건 말 그대로... 처음부터 끝까지 꼼꼼하게 봤다는 뜻이야. 세 번을. 혹시나 싶어서. 근데 세 번을 봐도 이건 C+이군. 아쉽게도 재수강 대상이 되었네. 슬퍼할 것 없어. 방학 계획 있었나? 취소하게. 내 여름 계절학기 수강 신청 창, 자네 이름이 이미 들어가 있거든. 자, 8월에 보세.",
          },
        ],
      },
      {
        id: "ending_cplus_02",
        subtype: "미련 곰탱이형",
        title: "내가 아직 덜 가르쳤나 보군",
        lines: [
          {
            role: "professor",
            text: "C+... C+이라. 자네, 이 점수가 뭘 의미하는지 아나? 내가 아직 자네한테 할 말이 남았다는 뜻이야. 학점은 거짓말을 안 하거든. 이번 학기엔 인연이 짧았지만, 걱정 말게. 방학 때 재수강으로 다시 만나세. 아, 그리고 다음엔 강의실에서 자지 말게나. 아니, 뭐... 자도 되는데 깨워 주는 건 이번 한 번으로 끝이야.",
          },
        ],
      },
      {
        id: "ending_cplus_03",
        subtype: "쿨한 재수강 환영형",
        title: "자네가 다시 올 줄 알았어",
        lines: [
          {
            role: "professor",
            text: "재수강이군. 놀랐나? 나는 안 놀랐어. 솔직히 이번 학기 자네 보면서 딱 느꼈거든— 아, 이 친구 한 번으론 부족하겠다고. 재능은 있는데 노력이 부족한 것 같기도. 방학 때 계절학기로 다시 들어오게. 같은 강의, 같은 강의실, 같은 교수야. 단, 이번엔 처음부터 제대로 하게나. 두 번째 기회는 내가 주는 거지만— 세 번째는 없으니까.",
          },
        ],
      },
    ],
    ...
    variants: [
      {
        ...
        subtype: "장르 급발진형",
        title: "진정한 멋사인으로 변신",
        stage_direction: ["교수님이 답안지를 내려놓고 갑자기 안경을 번쩍 치켜올린다."],
        lines: [
          {
            role: "professor",
            text: "답안지 아주 인상 깊었네. 정답은 하나도 안 맞았지만, 이 빽빽한 글씨에서 자네의 열정과 도전하는 자세를 엿볼 수 있었어. 그래서 말인데...",
          },
          { role: "narration", text: "갑자기 교수님이 실시간으로 사자로 변한다." },
          {
            role: "professor",
            text: "자네와 같은 학생과 함께라면 멋쟁이사자처럼 대학 활동을 하기에 문제없겠어! 어서 애니멀리그, 여름 연합 해커톤, 겨울 해커톤, 실리콘밸리 체험까지 내가 단 하루 만에 다 경험하게 해 주지. 자, 따라와!!",
          },
          {
            role: "narration",
            text: "정신을 차려 보니 나는 좌뇌로 기획, 우뇌로 코딩을 하는 멋사 기계가 되어 있었다. 교수님이 진정으로 바라는 모습이 이것인 걸까.. 멋쟁이 사자처럼 대학. 나의 삶. 나의 가치. 나의 빛. 난 지금 행복하다.",
          },
        ],
      },
      {
        id: "hidden_f_02",
        subtype: "갑분 스릴러형",
        title: "너무 많은 것을 알아버린 학생",
        stage_direction: [
          "답안지를 채점하던 교수님의 손이 멈춘다.",
          "붉은 펜에서 잉크가 뚝뚝 떨어진다.",
          "철컥— 연구실 문이 자동으로 잠기는 소리가 들린다.",
          "조명이 붉게 변한다.",
        ],
        lines: [
          {
            role: "professor",
            text: "__, 자네 답안지의 마지막 서술형 답안 말이야. 이걸 도대체 어디서 본 거지? 그건 내가 아무에게도 말하지 않은 내 미발표 논문의 1급 기밀인데.",
          },
          {
            role: "professor",
            text: "이런, 똑똑한 제자를 두는 건 언제나 위험이 따르는 법이지. 자네는 너무 많은 걸 알아버렸어. 제거해야겠네.",
            action: "선글라스를 끼며",
          },
          {
            role: "narration",
            text: "교수님이 품에서 꺼낸 것은 새 볼펜이 아니라 검은색 수면 마취제였다. 안 돼, 아직 CC도 안 해봤는데!! 수면 마취제를 맞고 나는 정신을 잃은 채 눈앞이 캄캄해졌다.",
          },
        ],
      },
      {
        ...
        title: "답안지로 환생해 버렸다",
        stage_direction: [
          "교수님이 답안지를 챙기며 다정하게 웃는다.",
          "화면 암전 후, 다시 밝아진다.",
        ],
        lines: [
          {
            role: "professor",
            text: "수고했네. 자네 답안지는 내가 집으로 가져가서 아주 찬찬히, 구석구석 채점하도록 하지.",
          },
          {
            role: "narration",
            text: "홀가분한 마음으로 강의실을 나와 횡단보도를 건너는 순간, '빠아앙—!!' 하는 굉음과 함께 브레이크가 고장 난 덤프트럭이 나를 덮쳤다.",
          },
          { role: "professor", text: "흠, 이 녀석은 글씨체가 왜 이리 지렁이 굴러가는 것 같아." },
          {
            role: "narration",
            text: "눈을 떠보니 나는 교수님의 책상 위에 놓인 한 장의 'A4용지(내 답안지)'로 환생해 있었다! 내 하얀 배 위로 교수님의 날카로운 붉은 펜이 무자비하게 그어지기 시작했다.",
          },
          { role: "narration", text: "아악! 살려줘요 교수님!! 거기 말고!! 으아아악!!!!!!!!!!!!!!!!" },
        ],
      },
    ],
  },
...
export const storyEpisodeBackdropMap: Record<string, string> = {
  ...
  ep06_night_bench: "/backgrounds/episodes/night-campus-walk.webp",
